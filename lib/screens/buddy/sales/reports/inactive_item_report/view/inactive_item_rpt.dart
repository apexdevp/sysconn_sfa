...
import 'package:sysconn_sfa/screens/buddy/sales/reports/inactive_item_report/controller/inactive_item_rpt_controller.dart';
import 'package:sysconn_sfa/widgets/nodatafoundwidget.dart';
import 'package:sysconn_sfa/widgets/sfa_custom_appbar.dart';

class InactiveItemReport extends StatelessWidget {
  const InactiveItemReport({super.key});

  @override
  Widget build(BuildContext context) {
    Size size = MediaQuery.of(context).size;
    final controller = Get.put(InactiveItemController());
    return Scaffold(
      appBar: SfaCustomAppbar(title: 'Inactive Item Report'),
      body: Column(
        children: [
          Card(
            child: Padding(
