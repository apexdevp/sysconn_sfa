                    ...
                    children: [
                      Expanded(
                        child: DropdownCustomList<String>(
                          ...
                          //   final selectedItem = opportunitiesEditController.stockItemList
                          //       .firstWhere((e) => e.itemName == value);

                          //   // Set product info
                          //   opportunitiesEditController.productDesc.text = selectedItem.itemName ?? '';
                          //   opportunitiesEditController.productCode.text = selectedItem.itemId ?? '';

                          //   // Handle rate
                          //   final rateText = selectedItem.priceListRate?.toString() ?? '';
                          //   if (rateText.isEmpty) {
                          //   // No rate → allow user typing
                          //   opportunitiesEditController.rateController.clear();
                          //   opportunitiesEditController.isRateEditable.value = true;
                          // } else {
                          //   // Auto-fill rate and optionally lock editing
                          //   opportunitiesEditController.rateController.text = rateText;

                          //   // Force listener trigger if needed
                          //   opportunitiesEditController.rateController.selection = TextSelection.fromPosition(
                          //       TextPosition(offset: opportunitiesEditController.rateController.text.length));

                          //   opportunitiesEditController.isRateEditable.value = false;
                          // }

                          //   // Set product info for API
                          //   opportunitiesEditController.selectedProductId = selectedItem.itemId ?? '';
                          //   opportunitiesEditController.selectedProductNameForApi = selectedItem.itemName ?? '';
